...
public class FutureDemo
{
    public static void main(String[] args) throws InterruptedException, ExecutionException
    {
        ...
        for (Person person : personList)
        {
            ...
            Future<PersonCredit> futureGetCredit = newFixedThreadPool.submit(() -> personCreditService.getPersonCreditScore(person.getId()));
            futurePersobCreditMap.put(personIdentity, futureGetCredit);
            //personRates.put(personIdentity, "");
        }
